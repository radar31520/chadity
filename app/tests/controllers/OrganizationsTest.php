...
class OrganizationsTest extends TestCase {
    ...
    {
        $this->mock = m::mock('Eloquent', 'Organization');
    ...
    public function setUp()
    {
        ...
        $this->attributes = Factory::organization(['id' => 1]);
    ...
    public function testUpdate()
    {
        ...
        $this->validate(true);
        $this->call('PATCH', 'organizations/1');

        $this->assertRedirectedTo('organizations/1');
    }
    ...
    public function testUpdateFails()
    {
        ...
        $this->assertRedirectedTo('organizations/1/edit');
        $this->assertSessionHasErrors();
        $this->assertSessionHas('message');
    }
    ...
    public function testDestroy()
    {
        ...
        $this->call('DELETE', 'organizations/1');
    }
